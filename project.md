# **EMit task from EVALITA 2023**
  [Task link](http://www.di.unito.it/~tutreeb/emit23/)
  [GitHub](https://github.com/oaraque/emit)
## Task A: Categorial Emotion Detection
...
## Binary classification vs Multi-class classification
  ...
  - Classificazione multi-class multi-label con N classi -> N unità di uscita con sigmoide (una per ogni classe) e la loss può essere la cross-entropia binaria. In questo caso ad ogni sample posso assegnare una o più label delle N classi.
